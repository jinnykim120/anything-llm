...
function buildMessages({
  ...
  const system =
    [
      ...
      '  · "timeline": 2~6개의 단계·일정·연혁. steps에 label(짧게: 시기/단계명)과 text(한 줄 설명)를 채웁니다.',
      ...
      "- 기간의 길이가 다른 값(연간 vs 반기·분기, 누계 vs 단기)은 한 차트의 같은 계열에 섞지 마십시오 — 마지막 값이 급락한 것처럼 오해됩니다. 그런 경우 chart는 같은 기간 단위끼리만 쓰고 나머지는 stat/불릿/표로 표시하십시오.",
