...
export default function ChatModelSelection({
  ...
  const discoveredModelIds = Array.isArray(customModels)
  ...
  const showFallbackModel = fallbackModel && !knownModelIds.has(fallbackModel);
  ...
  return (
    ...
    >
      {showFallbackModel && (
        <optgroup label="Configured model">
